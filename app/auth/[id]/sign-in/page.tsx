...
const page = () => {
  const searchParams = useSearchParams();
      ...
      const oauthUrl = buildOAuthLoginUrl('1073061011224-er7dfcqpri84rq2mjno3u33a69im02h5.apps.googleusercontent.com', 'http://localhost:3000/dashboard', nonce);
  ...
  return (
    <div>
      <LoginForm handleZkLogin={handleZkLogin}/>
    </div>
  )
}
